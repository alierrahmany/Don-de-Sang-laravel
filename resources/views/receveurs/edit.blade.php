...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <!-- En-tête -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Modifier le Receveur</h1>
            <p class="text-gray-600 mt-2">Modifiez les informations du receveur</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <!-- Formulaire -->
            <form action="{{ route('receveurs.update', $receveur) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="prenom" id="prenom" required
                            ...
                            value="{{ old('prenom', $receveur->prenom) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200"
                            value="{{ old('email', $receveur->email) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="ville" id="ville" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200"
                            value="{{ old('ville', $receveur->ville) }}"
                    ...
                    <div>
                        ...
                        <select name="groupe_sanguin" id="groupe_sanguin" required
                            ...
                            <option value="A+" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'A+' ? 'selected' : '' }}>A+</option>
                            <option value="A-" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'A-' ? 'selected' : '' }}>A-</option>
                            <option value="B+" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'B+' ? 'selected' : '' }}>B+</option>
                            <option value="B-" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'B-' ? 'selected' : '' }}>B-</option>
                            <option value="AB+" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'AB+' ? 'selected' : '' }}>AB+</option>
                            <option value="AB-" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'AB-' ? 'selected' : '' }}>AB-</option>
                            <option value="O+" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'O+' ? 'selected' : '' }}>O+</option>
                            <option value="O-" {{ old('groupe_sanguin', $receveur->groupe_sanguin) == 'O-' ? 'selected' : '' }}>O-</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_urgence" id="date_urgence"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200"
                            value="{{ old('date_urgence', $receveur->date_urgence ? $receveur->date_urgence->format('Y-m-d') : '') }}">
                        @error('date_urgence')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-4 pt-2">
                        <div class="flex items-center space-x-3">
                            <input type="checkbox" name="urgence" id="urgence" value="1"
                                {{ old('urgence', $receveur->urgence) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="checkbox" name="statut" id="statut" value="1"
                                {{ old('statut', $receveur->statut) ? 'checked' : '' }}
