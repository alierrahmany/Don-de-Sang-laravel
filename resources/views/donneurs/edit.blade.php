<!-- resources/views/donneurs/edit.blade.php -->
@extends('layouts.app')
...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Modifier le Donneur</h1>
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('donneurs.update', $donneur) }}" method="POST">
                    @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="prenom" id="prenom" required
                                       ...
                                       value="{{ old('prenom', $donneur->prenom) }}">
                                @error('prenom')
                            ...
                            <div>
                                ...
                                <input type="date" name="date_naissance" id="date_naissance" required
                                       class="mt-1 block w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"
                                       value="{{ old('date_naissance', $donneur->date_naissance->format('Y-m-d')) }}">
                            ...
                            <div>
                                ...
                                <select name="genre" id="genre" required
                                    ...
                                    <option value="Homme" {{ old('genre', $donneur->genre) == 'Homme' ? 'selected' : '' }}>Homme</option>
                                    <option value="Femme" {{ old('genre', $donneur->genre) == 'Femme' ? 'selected' : '' }}>Femme</option>
                                </select>
                                @error('genre')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="telephone" id="telephone" required
                                       class="mt-1 block w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"
                                       value="{{ old('telephone', $donneur->telephone) }}">
                                @error('telephone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="groupe_sanguin" id="groupe_sanguin" required
                                    ...
                                    @foreach($groupesSanguins as $groupe)
                                        <option value="{{ $groupe }}" {{ old('groupe_sanguin', $donneur->groupe_sanguin) == $groupe ? 'selected' : '' }}>
                                            {{ $groupe }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center">
                            <input type="checkbox" name="disponible" id="disponible" value="1"
                                   ...
                                   {{ old('disponible', $donneur->disponible) ? 'checked' : '' }}>
